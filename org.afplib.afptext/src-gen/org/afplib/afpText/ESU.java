 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afpText.ESU#getLID <em>LID</em>}</li>
 * </ul>
 *
 * @see org.afplib.afpText.AfpTextPackage#getESU()
 * @model
 * @generated
 */
public interface ESU extends triplet
{
   ...
   * @see #setLID(int)
   * @see org.afplib.afpText.AfpTextPackage#getESU_LID()
   * @model
   * @generated
   */
  int getLID();
  ...
  /**
   * Sets the value of the '{@link org.afplib.afpText.ESU#getLID <em>LID</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
