 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afpText.impl.GCBEZImpl#getRg <em>Rg</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GCBEZImpl extends tripletImpl implements GCBEZ
{
  ...
  public EList<GCBEZRG> getRg()
  {
    if (rg == null)
    {
      rg = new EObjectContainmentEList<GCBEZRG>(GCBEZRG.class, this, AfpTextPackage.GCBEZ__RG);
    }
    return rg;
  }
