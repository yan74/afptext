 ...
 * </p>
 * <ul>
 *   <li>{@link org.afplib.afpText.impl.ObjectOriginIdentifierImpl#getSystem <em>System</em>}</li>
 *   <li>{@link org.afplib.afpText.impl.ObjectOriginIdentifierImpl#getSysID <em>Sys ID</em>}</li>
 *   <li>{@link org.afplib.afpText.impl.ObjectOriginIdentifierImpl#getMedID <em>Med ID</em>}</li>
 *   <li>{@link org.afplib.afpText.impl.ObjectOriginIdentifierImpl#getDSID <em>DSID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ObjectOriginIdentifierImpl extends tripletImpl implements ObjectOriginIdentifier
{
   ...
   * @ordered
   */
  protected static final String MED_ID_EDEFAULT = null;
   ...
   * @ordered
   */
  protected String medID = MED_ID_EDEFAULT;
   ...
   * @ordered
   */
  protected static final String DSID_EDEFAULT = null;
   ...
   * @ordered
   */
  protected String dsid = DSID_EDEFAULT;
  ...
  {
    return AfpTextPackage.eINSTANCE.getObjectOriginIdentifier();
  }
  ...
  public void setSysID(String newSysID)
  {
    ...
    sysID = newSysID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__SYS_ID, oldSysID, sysID));
  }
   ...
   */
  @Override
  public void setMedID(String newMedID)
  {
    String oldMedID = medID;
    medID = newMedID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__MED_ID, oldMedID, medID));
  }
   ...
   */
  @Override
  public void setDSID(String newDSID)
  {
    String oldDSID = dsid;
    dsid = newDSID;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__DSID, oldDSID, dsid));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__MED_ID:
        return getMedID();
      case AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__DSID:
        return getDSID();
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__SYS_ID:
        ...
        return;
      case AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__MED_ID:
        setMedID((String)newValue);
        return;
      case AfpTextPackage.OBJECT_ORIGIN_IDENTIFIER__DSID:
        setDSID((String)newValue);
        return;
    }
